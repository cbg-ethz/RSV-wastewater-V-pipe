...
with open('/cluster/project/pangolin/processes/rsv/rsv_downstream_analysis/RSV-wastewater-V-pipe/utilities/shared/RSV_data_analysis/rsv_definitions/RSVB_nucleotide_mutations_0.9.json', 'r') as file:
...
fig, axs = plt.subplots(nrows=2, ncols=1, figsize=(200, 20), gridspec_kw={'height_ratios': [20, 2]})
...
axs[1].tick_params(axis='y', labelsize=15, rotation=0)
...
plt.suptitle("Mutation frequencies (RSV-B, 2025-2026 season)",
